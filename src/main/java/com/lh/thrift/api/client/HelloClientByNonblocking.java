 ...
 */
public class HelloClientByNonblocking {
    ...
    private void startClient(){
        ...
        try {
            tTransport = new TFramedTransport(new TSocket(Contants.SERVER_IP, Contants.SERVER_PORT, Contants.TIMEOUT));
    ...
    public static void main(String[] args) {
        new HelloClientByNonblocking().startClient();
    }
}
